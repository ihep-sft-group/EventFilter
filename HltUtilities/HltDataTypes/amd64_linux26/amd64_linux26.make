...
HLTUTILITIESROOT=/junofs/users/liuyan/OEC/EventFilter/HltUtilities/HltDataTypes
HltUtilities_root=/junofs/users/liuyan/OEC/EventFilter/HltUtilities/HltDataTypes
HLTUTILITIESVERSION=HltDataTypes
HltUtilities_cmtpath=/junofs/users/liuyan/OEC/EventFilter
HltUtilities_project=EventFilter
...
includes= $(ppcmd)"$(HltUtilities_root)"  $(ppcmd)"$(srcdir)" $(ppcmd)"/junofs/users/liuyan/OEC/EventFilter/HltUtilities/HltDataTypes/include" $(ppcmd)"/junofs/users/liuyan/OEC/EventFilter/InstallArea/include" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre1/sniper/InstallArea/include" $(use_includes)
...
HltUtilities_linkopts= -lHltDataTypes 
HltDataTypes_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(HltDataTypes_use_linkopts)
HltDataTypes_use_linkopts=    $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
HltUtilities_stamps=${HLTUTILITIESROOT}/${BINDIR}/HltDataTypes.stamp 
HltUtilities_linker_library=HltDataTypes
tag=amd64_linux26
package=HltUtilities
version=HltDataTypes
PACKAGE_ROOT=$(HLTUTILITIESROOT)
srcdir=../src
bin=../$(HltUtilities_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/users/liuyan/OEC/EventFilter/HltUtilities/HltDataTypes/amd64_linux26/
project=EventFilter
...
use_linkopts= $(cmt_installarea_linkopts)   $(HltUtilities_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
...
use_stamps=  $(HltUtilities_stamps)  $(SniperKernel_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps) 
use_cflags=  $(HltUtilities_cflags)  $(SniperKernel_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags) 
use_pp_cflags=  $(HltUtilities_pp_cflags)  $(SniperKernel_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags) 
use_cppflags=  $(HltUtilities_cppflags)  $(SniperKernel_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags) 
use_pp_cppflags=  $(HltUtilities_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags) 
use_fflags=  $(HltUtilities_fflags)  $(SniperKernel_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags) 
use_pp_fflags=  $(HltUtilities_pp_fflags)  $(SniperKernel_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags) 
use_libraries= $(SniperKernel_libraries)  $(SniperPolicy_libraries)  $(Boost_libraries)  $(Python_libraries) 
fincludes= $(includes)
HltDataTypes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
HltUtilities_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= HltDataTypes HltUtilities_python install_more_includes 
all_constituents= $(constituents)
constituentsclean= install_more_includesclean HltUtilities_pythonclean HltDataTypesclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
HltDataTypesprototype_dependencies= $(HltDataTypescompile_dependencies)

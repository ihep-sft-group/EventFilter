...
#cmt_local_tagfile = $(EventFilter_tag).make
cmt_local_tagfile = $(bin)$(EventFilter_tag).make
...
cmt_local_setup_EventFilter = $(bin)setup_EventFilter$$$$.make
...
$(cmt_local_tagfile_EventFilter) :
	...
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_EventFilter)"; \
	  test ! -f $(cmt_local_setup_EventFilter) || \rm -f $(cmt_local_setup_EventFilter); \
	  trap '\rm -f $(cmt_local_setup_EventFilter)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(EventFilter_extratags) show setup >$(cmt_local_setup_EventFilter) && \
	  if [ -f $(cmt_final_setup_EventFilter) ] && \
	    \cmp -s $(cmt_final_setup_EventFilter) $(cmt_local_setup_EventFilter); then \
	    \rm $(cmt_local_setup_EventFilter); else \
	    \mv -f $(cmt_local_setup_EventFilter) $(cmt_final_setup_EventFilter); fi
...
not_EventFilter_dependencies = { n=0; for p in $?; do m=0; for d in $(EventFilter_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
EventFilterdirs :
	@if test ! -d $(bin)EventFilter; then $(mkdir) -p $(bin)EventFilter; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)EventFilter
else
EventFilterdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)EventFilter
#
#$(cmt_local_EventFilter_makefile) :: $(EventFilter_dependencies) $(cmt_local_tagfile_EventFilter) build_library_links dirs EventFilterdirs
#else
...
ifndef QUICK
$(cmt_local_EventFilter_makefile) : $(EventFilter_dependencies) build_library_links
	$(echo) "(constituents.make) Building EventFilter.make"; \
	  $(cmtexe) -tag=$(tags) $(EventFilter_extratags) build constituent_config -out=$(cmt_local_EventFilter_makefile) EventFilter
else
$(cmt_local_EventFilter_makefile) : $(EventFilter_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_EventFilter) ] || \
	  [ ! -f $(cmt_final_setup_EventFilter) ] || \
	  $(not_EventFilter_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building EventFilter.make"; \
	  $(cmtexe) -tag=$(tags) $(EventFilter_extratags) build constituent_config -out=$(cmt_local_EventFilter_makefile) EventFilter; \
	  fi
endif
...
$(cmt_local_EventFilter_makefile) : $(EventFilter_dependencies) build_library_links
	$(echo) "(constituents.make) Building EventFilter.make"; \
	  $(cmtexe) -f=$(bin)EventFilter.in -tag=$(tags) $(EventFilter_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_EventFilter_makefile) EventFilter
else
$(cmt_local_EventFilter_makefile) : $(EventFilter_dependencies) $(cmt_build_library_linksstamp) $(bin)EventFilter.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_EventFilter) ] || \
	  [ ! -f $(cmt_final_setup_EventFilter) ] || \
	  $(not_EventFilter_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
EventFilter :: $(EventFilter_dependencies) $(cmt_local_EventFilter_makefile) dirs EventFilterdirs
	$(echo) "(constituents.make) Starting EventFilter"
	@if test -f $(cmt_local_EventFilter_makefile); then \
	  $(MAKE) -f $(cmt_local_EventFilter_makefile) EventFilter; \
	  fi
#	@$(MAKE) -f $(cmt_local_EventFilter_makefile) EventFilter
...
EventFilterclean :: $(EventFilterclean_dependencies) ##$(cmt_local_EventFilter_makefile)
	...
	@-if test -f $(cmt_local_EventFilter_makefile); then \
	  $(MAKE) -f $(cmt_local_EventFilter_makefile) EventFilterclean; \
	fi
	$(echo) "(constituents.make) EventFilterclean done"
#	@-$(MAKE) -f $(cmt_local_EventFilter_makefile) EventFilterclean
...
EventFilterinstall :: $(EventFilter_dependencies) $(cmt_local_EventFilter_makefile)
	...
	@-$(MAKE) -f $(cmt_local_EventFilter_makefile) install
	$(echo) "(constituents.make) install EventFilter done"

uninstall : EventFilteruninstall

$(foreach d,$(EventFilter_dependencies),$(eval $(d)uninstall_dependencies += EventFilteruninstall))

EventFilteruninstall : $(EventFilteruninstall_dependencies) ##$(cmt_local_EventFilter_makefile)
	$(echo) "(constituents.make) Starting uninstall EventFilter"
	@if test -f $(cmt_local_EventFilter_makefile); then \
	  $(MAKE) -f $(cmt_local_EventFilter_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_EventFilter_makefile) uninstall
	$(echo) "(constituents.make) uninstall EventFilter done"

remove_library_links :: EventFilteruninstall
...
cmt_local_setup_EFTest = $(bin)setup_EFTest$$$$.make
...
EFTest_extratags = -tag_add=target_EFTest

#$(cmt_local_tagfile_EFTest) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_EFTest) ::
else
$(cmt_local_tagfile_EFTest) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_EFTest); then /bin/rm -f $(cmt_local_tagfile_EFTest); fi ; \
	  $(cmtexe) -tag=$(tags) $(EFTest_extratags) build tag_makefile >>$(cmt_local_tagfile_EFTest)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_EFTest)"; \
	  test ! -f $(cmt_local_setup_EFTest) || \rm -f $(cmt_local_setup_EFTest); \
	  trap '\rm -f $(cmt_local_setup_EFTest)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(EFTest_extratags) show setup >$(cmt_local_setup_EFTest) && \
	  if [ -f $(cmt_final_setup_EFTest) ] && \
	    \cmp -s $(cmt_final_setup_EFTest) $(cmt_local_setup_EFTest); then \
	    \rm $(cmt_local_setup_EFTest); else \
	    \mv -f $(cmt_local_setup_EFTest) $(cmt_final_setup_EFTest); fi
...
not_EFTest_dependencies = { n=0; for p in $?; do m=0; for d in $(EFTest_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
EFTestdirs :
	@if test ! -d $(bin)EFTest; then $(mkdir) -p $(bin)EFTest; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)EFTest
else
EFTestdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)EFTest
#
#$(cmt_local_EFTest_makefile) :: $(EFTest_dependencies) $(cmt_local_tagfile_EFTest) build_library_links dirs EFTestdirs
#else
#$(cmt_local_EFTest_makefile) :: $(EFTest_dependencies) $(cmt_local_tagfile_EFTest) build_library_links dirs
#endif
#else
#$(cmt_local_EFTest_makefile) :: $(cmt_local_tagfile_EFTest)
#endif

ifdef cmt_EFTest_has_target_tag

ifndef QUICK
$(cmt_local_EFTest_makefile) : $(EFTest_dependencies) build_library_links
	$(echo) "(constituents.make) Building EFTest.make"; \
	  $(cmtexe) -tag=$(tags) $(EFTest_extratags) build constituent_config -out=$(cmt_local_EFTest_makefile) EFTest
else
$(cmt_local_EFTest_makefile) : $(EFTest_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_EFTest) ] || \
	  [ ! -f $(cmt_final_setup_EFTest) ] || \
	  $(not_EFTest_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building EFTest.make"; \
	  $(cmtexe) -tag=$(tags) $(EFTest_extratags) build constituent_config -out=$(cmt_local_EFTest_makefile) EFTest; \
	  fi
endif
...
$(cmt_local_EFTest_makefile) : $(EFTest_dependencies) build_library_links
	$(echo) "(constituents.make) Building EFTest.make"; \
	  $(cmtexe) -f=$(bin)EFTest.in -tag=$(tags) $(EFTest_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_EFTest_makefile) EFTest
else
$(cmt_local_EFTest_makefile) : $(EFTest_dependencies) $(cmt_build_library_linksstamp) $(bin)EFTest.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_EFTest) ] || \
	  [ ! -f $(cmt_final_setup_EFTest) ] || \
	  $(not_EFTest_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(EFTest_extratags) build constituent_makefile -out=$(cmt_local_EFTest_makefile) EFTest

EFTest :: $(EFTest_dependencies) $(cmt_local_EFTest_makefile) dirs EFTestdirs
	$(echo) "(constituents.make) Starting EFTest"
	@if test -f $(cmt_local_EFTest_makefile); then \
	  $(MAKE) -f $(cmt_local_EFTest_makefile) EFTest; \
	  fi
#	@$(MAKE) -f $(cmt_local_EFTest_makefile) EFTest
	$(echo) "(constituents.make) EFTest done"

clean :: EFTestclean

EFTestclean :: $(EFTestclean_dependencies) ##$(cmt_local_EFTest_makefile)
	$(echo) "(constituents.make) Starting EFTestclean"
	@-if test -f $(cmt_local_EFTest_makefile); then \
	  $(MAKE) -f $(cmt_local_EFTest_makefile) EFTestclean; \
	fi
	$(echo) "(constituents.make) EFTestclean done"
#	@-$(MAKE) -f $(cmt_local_EFTest_makefile) EFTestclean

##	  /bin/rm -f $(cmt_local_EFTest_makefile) $(bin)EFTest_dependencies.make

install :: EFTestinstall

EFTestinstall :: $(EFTest_dependencies) $(cmt_local_EFTest_makefile)
	$(echo) "(constituents.make) Starting install EFTest"
	@-$(MAKE) -f $(cmt_local_EFTest_makefile) install
	$(echo) "(constituents.make) install EFTest done"

uninstall : EFTestuninstall

$(foreach d,$(EFTest_dependencies),$(eval $(d)uninstall_dependencies += EFTestuninstall))

EFTestuninstall : $(EFTestuninstall_dependencies) ##$(cmt_local_EFTest_makefile)
	$(echo) "(constituents.make) Starting uninstall EFTest"
	@if test -f $(cmt_local_EFTest_makefile); then \
	  $(MAKE) -f $(cmt_local_EFTest_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_EFTest_makefile) uninstall
	$(echo) "(constituents.make) uninstall EFTest done"

remove_library_links :: EFTestuninstall
...
#cmt_local_tagfile_config = $(EventFilter_tag)_config.make
cmt_local_tagfile_config = $(bin)$(EventFilter_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)EventFilter_configsetup.make
...
#cmt_local_tagfile_config = $(EventFilter_tag).make
cmt_local_tagfile_config = $(bin)$(EventFilter_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)EventFiltersetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(EventFilter_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(EventFilter_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)EventFilter_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(EventFilter_tag).make
cmt_local_tagfile_install_includes = $(bin)$(EventFilter_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)EventFiltersetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(EventFilter_tag)_make.make
cmt_local_tagfile_make = $(bin)$(EventFilter_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)EventFilter_makesetup.make
...
#cmt_local_tagfile_make = $(EventFilter_tag).make
cmt_local_tagfile_make = $(bin)$(EventFilter_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)EventFiltersetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(EventFilter_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(EventFilter_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)EventFilter_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(EventFilter_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(EventFilter_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)EventFiltersetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(EventFilter_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(EventFilter_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)EventFilter_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(EventFilter_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(EventFilter_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)EventFiltersetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(EventFilter_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(EventFilter_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)EventFilter_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(EventFilter_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(EventFilter_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)EventFiltersetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(EventFilter_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(EventFilter_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)EventFilter_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(EventFilter_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(EventFilter_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)EventFiltersetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(EventFilter_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(EventFilter_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)EventFilter_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(EventFilter_tag).make
cmt_local_tagfile_TestProject = $(bin)$(EventFilter_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)EventFiltersetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(EventFilter_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(EventFilter_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)EventFilter_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(EventFilter_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(EventFilter_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)EventFiltersetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(EventFilter_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(EventFilter_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)EventFilter_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(EventFilter_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(EventFilter_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)EventFiltersetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make

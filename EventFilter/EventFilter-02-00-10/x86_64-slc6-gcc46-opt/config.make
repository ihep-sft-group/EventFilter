...
#  Document config
#
#   Generated Mon Mar 23 20:59:35 2020  by boss
#
#====================================
...
config :: ../EventFilter/config.h
	@/bin/echo "------> config.h ok"

../EventFilter/config.h :: ../EventFilter/config.h.in
	@if test -f ../EventFilter/config.h.in; then \
	  cd ../EventFilter; \

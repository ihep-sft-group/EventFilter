...
HltAlgorithmscompile : $(bin)EFSectorHits.o $(bin)EFDetectorHits.o $(bin)IEFAlgorithm.o ;
...
$(HltAlgorithmslib) :: $(bin)EFSectorHits.o $(bin)EFDetectorHits.o $(bin)IEFAlgorithm.o
	$(lib_echo) "static library $@"
	$(lib_silent) [ ! -f $@ ] || \rm -f $@
	$(lib_silent) $(ar) $(HltAlgorithmslib) $(bin)EFSectorHits.o $(bin)EFDetectorHits.o $(bin)IEFAlgorithm.o
...
HltAlgorithmsclean ::
	...
	$(cleanup_silent) /bin/rm -f $(bin)EFSectorHits.o $(bin)EFDetectorHits.o $(bin)IEFAlgorithm.o
	$(cleanup_silent) /bin/rm -f $(patsubst %.o,%.d,$(bin)EFSectorHits.o $(bin)EFDetectorHits.o $(bin)IEFAlgorithm.o) $(patsubst %.o,%.dep,$(bin)EFSectorHits.o $(bin)EFDetectorHits.o $(bin)IEFAlgorithm.o) $(patsubst %.o,%.d.stamp,$(bin)EFSectorHits.o $(bin)EFDetectorHits.o $(bin)IEFAlgorithm.o)
...
$(bin)HltAlgorithms_dependencies.make : $(use_requirements) $(cmt_final_setup_HltAlgorithms)
	$(echo) "(HltAlgorithms.make) Rebuilding $@"; \
	  $(build_dependencies) -out=$@ -start_all $(src)EFSectorHits.cc $(src)EFDetectorHits.cc $(src)IEFAlgorithm.cc -end_all $(includes) $(app_HltAlgorithms_cppflags) $(lib_HltAlgorithms_cppflags) -name=HltAlgorithms $? -f=$(cmt_dependencies_in_HltAlgorithms) -without_cmt

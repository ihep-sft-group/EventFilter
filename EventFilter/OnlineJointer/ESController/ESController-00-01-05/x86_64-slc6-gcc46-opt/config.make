...
#  Document config
#
#   Generated Mon Mar 23 20:58:01 2020  by boss
#
#====================================
...
config :: ../ESController/config.h
	@/bin/echo "------> config.h ok"

../ESController/config.h :: ../ESController/config.h.in
	@if test -f ../ESController/config.h.in; then \
	  cd ../ESController; \

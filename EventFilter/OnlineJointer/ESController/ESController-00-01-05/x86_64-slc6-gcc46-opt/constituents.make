...
#cmt_local_tagfile = $(ESController_tag).make
cmt_local_tagfile = $(bin)$(ESController_tag).make
...
cmt_local_setup_ESController = $(bin)setup_ESController$$$$.make
...
ESController_extratags = -tag_add=target_ESController

#$(cmt_local_tagfile_ESController) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_ESController) ::
else
$(cmt_local_tagfile_ESController) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_ESController); then /bin/rm -f $(cmt_local_tagfile_ESController); fi ; \
	  $(cmtexe) -tag=$(tags) $(ESController_extratags) build tag_makefile >>$(cmt_local_tagfile_ESController)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_ESController)"; \
	  test ! -f $(cmt_local_setup_ESController) || \rm -f $(cmt_local_setup_ESController); \
	  trap '\rm -f $(cmt_local_setup_ESController)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(ESController_extratags) show setup >$(cmt_local_setup_ESController) && \
	  if [ -f $(cmt_final_setup_ESController) ] && \
	    \cmp -s $(cmt_final_setup_ESController) $(cmt_local_setup_ESController); then \
	    \rm $(cmt_local_setup_ESController); else \
	    \mv -f $(cmt_local_setup_ESController) $(cmt_final_setup_ESController); fi
...
not_ESController_dependencies = { n=0; for p in $?; do m=0; for d in $(ESController_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
ESControllerdirs :
	@if test ! -d $(bin)ESController; then $(mkdir) -p $(bin)ESController; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)ESController
else
ESControllerdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)ESController
#
#$(cmt_local_ESController_makefile) :: $(ESController_dependencies) $(cmt_local_tagfile_ESController) build_library_links dirs ESControllerdirs
#else
#$(cmt_local_ESController_makefile) :: $(ESController_dependencies) $(cmt_local_tagfile_ESController) build_library_links dirs
#endif
#else
#$(cmt_local_ESController_makefile) :: $(cmt_local_tagfile_ESController)
#endif

ifdef cmt_ESController_has_target_tag

ifndef QUICK
$(cmt_local_ESController_makefile) : $(ESController_dependencies) build_library_links
	$(echo) "(constituents.make) Building ESController.make"; \
	  $(cmtexe) -tag=$(tags) $(ESController_extratags) build constituent_config -out=$(cmt_local_ESController_makefile) ESController
else
$(cmt_local_ESController_makefile) : $(ESController_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_ESController) ] || \
	  [ ! -f $(cmt_final_setup_ESController) ] || \
	  $(not_ESController_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building ESController.make"; \
	  $(cmtexe) -tag=$(tags) $(ESController_extratags) build constituent_config -out=$(cmt_local_ESController_makefile) ESController; \
	  fi
endif
...
$(cmt_local_ESController_makefile) : $(ESController_dependencies) build_library_links
	$(echo) "(constituents.make) Building ESController.make"; \
	  $(cmtexe) -f=$(bin)ESController.in -tag=$(tags) $(ESController_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_ESController_makefile) ESController
else
$(cmt_local_ESController_makefile) : $(ESController_dependencies) $(cmt_build_library_linksstamp) $(bin)ESController.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_ESController) ] || \
	  [ ! -f $(cmt_final_setup_ESController) ] || \
	  $(not_ESController_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(ESController_extratags) build constituent_makefile -out=$(cmt_local_ESController_makefile) ESController

ESController :: $(ESController_dependencies) $(cmt_local_ESController_makefile) dirs ESControllerdirs
	$(echo) "(constituents.make) Starting ESController"
	@if test -f $(cmt_local_ESController_makefile); then \
	  $(MAKE) -f $(cmt_local_ESController_makefile) ESController; \
	  fi
#	@$(MAKE) -f $(cmt_local_ESController_makefile) ESController
	$(echo) "(constituents.make) ESController done"

clean :: ESControllerclean

ESControllerclean :: $(ESControllerclean_dependencies) ##$(cmt_local_ESController_makefile)
	$(echo) "(constituents.make) Starting ESControllerclean"
	@-if test -f $(cmt_local_ESController_makefile); then \
	  $(MAKE) -f $(cmt_local_ESController_makefile) ESControllerclean; \
	fi
	$(echo) "(constituents.make) ESControllerclean done"
#	@-$(MAKE) -f $(cmt_local_ESController_makefile) ESControllerclean

##	  /bin/rm -f $(cmt_local_ESController_makefile) $(bin)ESController_dependencies.make

install :: ESControllerinstall

ESControllerinstall :: $(ESController_dependencies) $(cmt_local_ESController_makefile)
	$(echo) "(constituents.make) Starting install ESController"
	@-$(MAKE) -f $(cmt_local_ESController_makefile) install
	$(echo) "(constituents.make) install ESController done"

uninstall : ESControlleruninstall

$(foreach d,$(ESController_dependencies),$(eval $(d)uninstall_dependencies += ESControlleruninstall))

ESControlleruninstall : $(ESControlleruninstall_dependencies) ##$(cmt_local_ESController_makefile)
	$(echo) "(constituents.make) Starting uninstall ESController"
	@if test -f $(cmt_local_ESController_makefile); then \
	  $(MAKE) -f $(cmt_local_ESController_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_ESController_makefile) uninstall
	$(echo) "(constituents.make) uninstall ESController done"

remove_library_links :: ESControlleruninstall
...
#cmt_local_tagfile_config = $(ESController_tag)_config.make
cmt_local_tagfile_config = $(bin)$(ESController_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)ESController_configsetup.make
...
#cmt_local_tagfile_config = $(ESController_tag).make
cmt_local_tagfile_config = $(bin)$(ESController_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)ESControllersetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(ESController_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(ESController_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)ESController_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(ESController_tag).make
cmt_local_tagfile_install_includes = $(bin)$(ESController_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)ESControllersetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(ESController_tag)_make.make
cmt_local_tagfile_make = $(bin)$(ESController_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)ESController_makesetup.make
...
#cmt_local_tagfile_make = $(ESController_tag).make
cmt_local_tagfile_make = $(bin)$(ESController_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)ESControllersetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(ESController_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(ESController_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)ESController_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(ESController_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(ESController_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)ESControllersetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(ESController_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(ESController_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)ESController_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(ESController_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(ESController_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)ESControllersetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(ESController_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(ESController_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)ESController_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(ESController_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(ESController_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)ESControllersetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(ESController_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(ESController_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)ESController_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(ESController_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(ESController_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)ESControllersetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(ESController_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(ESController_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)ESController_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(ESController_tag).make
cmt_local_tagfile_TestProject = $(bin)$(ESController_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)ESControllersetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(ESController_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(ESController_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)ESController_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(ESController_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(ESController_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)ESControllersetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(ESController_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(ESController_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)ESController_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(ESController_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(ESController_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)ESControllersetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make

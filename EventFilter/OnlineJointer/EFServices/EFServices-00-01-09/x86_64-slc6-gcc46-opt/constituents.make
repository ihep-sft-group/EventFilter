...
#cmt_local_tagfile = $(EFServices_tag).make
cmt_local_tagfile = $(bin)$(EFServices_tag).make
...
cmt_local_setup_EFServices = $(bin)setup_EFServices$$$$.make
...
EFServices_extratags = -tag_add=target_EFServices

#$(cmt_local_tagfile_EFServices) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_EFServices) ::
else
$(cmt_local_tagfile_EFServices) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_EFServices); then /bin/rm -f $(cmt_local_tagfile_EFServices); fi ; \
	  $(cmtexe) -tag=$(tags) $(EFServices_extratags) build tag_makefile >>$(cmt_local_tagfile_EFServices)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_EFServices)"; \
	  test ! -f $(cmt_local_setup_EFServices) || \rm -f $(cmt_local_setup_EFServices); \
	  trap '\rm -f $(cmt_local_setup_EFServices)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(EFServices_extratags) show setup >$(cmt_local_setup_EFServices) && \
	  if [ -f $(cmt_final_setup_EFServices) ] && \
	    \cmp -s $(cmt_final_setup_EFServices) $(cmt_local_setup_EFServices); then \
	    \rm $(cmt_local_setup_EFServices); else \
	    \mv -f $(cmt_local_setup_EFServices) $(cmt_final_setup_EFServices); fi
...
not_EFServices_dependencies = { n=0; for p in $?; do m=0; for d in $(EFServices_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
EFServicesdirs :
	@if test ! -d $(bin)EFServices; then $(mkdir) -p $(bin)EFServices; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)EFServices
else
EFServicesdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)EFServices
#
#$(cmt_local_EFServices_makefile) :: $(EFServices_dependencies) $(cmt_local_tagfile_EFServices) build_library_links dirs EFServicesdirs
#else
#$(cmt_local_EFServices_makefile) :: $(EFServices_dependencies) $(cmt_local_tagfile_EFServices) build_library_links dirs
#endif
#else
#$(cmt_local_EFServices_makefile) :: $(cmt_local_tagfile_EFServices)
#endif

ifdef cmt_EFServices_has_target_tag

ifndef QUICK
$(cmt_local_EFServices_makefile) : $(EFServices_dependencies) build_library_links
	$(echo) "(constituents.make) Building EFServices.make"; \
	  $(cmtexe) -tag=$(tags) $(EFServices_extratags) build constituent_config -out=$(cmt_local_EFServices_makefile) EFServices
else
$(cmt_local_EFServices_makefile) : $(EFServices_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_EFServices) ] || \
	  [ ! -f $(cmt_final_setup_EFServices) ] || \
	  $(not_EFServices_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building EFServices.make"; \
	  $(cmtexe) -tag=$(tags) $(EFServices_extratags) build constituent_config -out=$(cmt_local_EFServices_makefile) EFServices; \
	  fi
endif
...
$(cmt_local_EFServices_makefile) : $(EFServices_dependencies) build_library_links
	$(echo) "(constituents.make) Building EFServices.make"; \
	  $(cmtexe) -f=$(bin)EFServices.in -tag=$(tags) $(EFServices_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_EFServices_makefile) EFServices
else
$(cmt_local_EFServices_makefile) : $(EFServices_dependencies) $(cmt_build_library_linksstamp) $(bin)EFServices.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_EFServices) ] || \
	  [ ! -f $(cmt_final_setup_EFServices) ] || \
	  $(not_EFServices_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(EFServices_extratags) build constituent_makefile -out=$(cmt_local_EFServices_makefile) EFServices

EFServices :: $(EFServices_dependencies) $(cmt_local_EFServices_makefile) dirs EFServicesdirs
	$(echo) "(constituents.make) Starting EFServices"
	@if test -f $(cmt_local_EFServices_makefile); then \
	  $(MAKE) -f $(cmt_local_EFServices_makefile) EFServices; \
	  fi
#	@$(MAKE) -f $(cmt_local_EFServices_makefile) EFServices
	$(echo) "(constituents.make) EFServices done"

clean :: EFServicesclean

EFServicesclean :: $(EFServicesclean_dependencies) ##$(cmt_local_EFServices_makefile)
	$(echo) "(constituents.make) Starting EFServicesclean"
	@-if test -f $(cmt_local_EFServices_makefile); then \
	  $(MAKE) -f $(cmt_local_EFServices_makefile) EFServicesclean; \
	fi
	$(echo) "(constituents.make) EFServicesclean done"
#	@-$(MAKE) -f $(cmt_local_EFServices_makefile) EFServicesclean

##	  /bin/rm -f $(cmt_local_EFServices_makefile) $(bin)EFServices_dependencies.make

install :: EFServicesinstall

EFServicesinstall :: $(EFServices_dependencies) $(cmt_local_EFServices_makefile)
	$(echo) "(constituents.make) Starting install EFServices"
	@-$(MAKE) -f $(cmt_local_EFServices_makefile) install
	$(echo) "(constituents.make) install EFServices done"

uninstall : EFServicesuninstall

$(foreach d,$(EFServices_dependencies),$(eval $(d)uninstall_dependencies += EFServicesuninstall))

EFServicesuninstall : $(EFServicesuninstall_dependencies) ##$(cmt_local_EFServices_makefile)
	$(echo) "(constituents.make) Starting uninstall EFServices"
	@if test -f $(cmt_local_EFServices_makefile); then \
	  $(MAKE) -f $(cmt_local_EFServices_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_EFServices_makefile) uninstall
	$(echo) "(constituents.make) uninstall EFServices done"

remove_library_links :: EFServicesuninstall
...
#cmt_local_tagfile_config = $(EFServices_tag)_config.make
cmt_local_tagfile_config = $(bin)$(EFServices_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)EFServices_configsetup.make
...
#cmt_local_tagfile_config = $(EFServices_tag).make
cmt_local_tagfile_config = $(bin)$(EFServices_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)EFServicessetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(EFServices_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(EFServices_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)EFServices_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(EFServices_tag).make
cmt_local_tagfile_install_includes = $(bin)$(EFServices_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)EFServicessetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(EFServices_tag)_make.make
cmt_local_tagfile_make = $(bin)$(EFServices_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)EFServices_makesetup.make
...
#cmt_local_tagfile_make = $(EFServices_tag).make
cmt_local_tagfile_make = $(bin)$(EFServices_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)EFServicessetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(EFServices_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(EFServices_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)EFServices_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(EFServices_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(EFServices_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)EFServicessetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(EFServices_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(EFServices_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)EFServices_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(EFServices_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(EFServices_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)EFServicessetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(EFServices_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(EFServices_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)EFServices_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(EFServices_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(EFServices_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)EFServicessetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(EFServices_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(EFServices_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)EFServices_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(EFServices_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(EFServices_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)EFServicessetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(EFServices_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(EFServices_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)EFServices_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(EFServices_tag).make
cmt_local_tagfile_TestProject = $(bin)$(EFServices_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)EFServicessetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(EFServices_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(EFServices_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)EFServices_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(EFServices_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(EFServices_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)EFServicessetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(EFServices_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(EFServices_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)EFServices_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(EFServices_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(EFServices_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)EFServicessetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make

...
includes= $(ppcmd)"$(HltSteering_root)"  $(ppcmd)"$(srcdir)" $(ppcmd)"/junofs/users/liuyan/OEC/EventFilter/HltProcessor/HltSteering/include" $(ppcmd)"/junofs/users/liuyan/OEC/EventFilter/InstallArea/include" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre1/sniper/InstallArea/include" $(use_includes)
...
HltSteering_use_linkopts= -L$(libxercesc)/lib -lxerces-c    $(HltConfig_linkopts)  $(HltSteerData_linkopts)  $(HltStore_linkopts)  $(HltDataTypes_linkopts)  $(HltResult_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
...
use_linkopts= $(cmt_installarea_linkopts)   $(HltSteering_linkopts)  $(HltConfig_linkopts)  $(HltSteerData_linkopts)  $(HltStore_linkopts)  $(HltDataTypes_linkopts)  $(HltResult_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
...
use_includes= $(ppcmd)"$(HltConfig_root)/src" $(ppcmd)"/junofs/users/liuyan/OEC/EventFilter/HltProcessor/HltConfig/include" $(ppcmd)"$(HltSteerData_root)/src" $(ppcmd)"/junofs/users/liuyan/OEC/EventFilter/HltProcessor/HltSteerData/include" $(ppcmd)"$(HltStore_root)/src" $(ppcmd)"/junofs/users/liuyan/OEC/EventFilter/HltUtilities/HltStore/include" $(ppcmd)"$(HltDataTypes_root)/src" $(ppcmd)"/junofs/users/liuyan/OEC/EventFilter/HltUtilities/HltDataTypes/include" $(ppcmd)"$(HltResult_root)/src" $(ppcmd)"/junofs/users/liuyan/OEC/EventFilter/HltProcessor/HltResult/include" $(ppcmd)"$(SniperKernel_root)/src" $(ppcmd)"$(SniperPolicy_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre1/ExternalLibs/Boost/1.72.0/include" $(ppcmd)"$(Python_root)/src" 
use_fincludes= $(use_includes)
use_stamps=  $(HltSteering_stamps)  $(HltConfig_stamps)  $(HltSteerData_stamps)  $(HltStore_stamps)  $(HltDataTypes_stamps)  $(HltResult_stamps)  $(SniperKernel_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps) 
use_cflags=  $(HltSteering_cflags)  $(HltConfig_cflags)  $(HltSteerData_cflags)  $(HltStore_cflags)  $(HltDataTypes_cflags)  $(HltResult_cflags)  $(SniperKernel_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags) 
use_pp_cflags=  $(HltSteering_pp_cflags)  $(HltConfig_pp_cflags)  $(HltSteerData_pp_cflags)  $(HltStore_pp_cflags)  $(HltDataTypes_pp_cflags)  $(HltResult_pp_cflags)  $(SniperKernel_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags) 
use_cppflags=  $(HltSteering_cppflags)  $(HltConfig_cppflags)  $(HltSteerData_cppflags)  $(HltStore_cppflags)  $(HltDataTypes_cppflags)  $(HltResult_cppflags)  $(SniperKernel_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags) 
use_pp_cppflags=  $(HltSteering_pp_cppflags)  $(HltConfig_pp_cppflags)  $(HltSteerData_pp_cppflags)  $(HltStore_pp_cppflags)  $(HltDataTypes_pp_cppflags)  $(HltResult_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags) 
use_fflags=  $(HltSteering_fflags)  $(HltConfig_fflags)  $(HltSteerData_fflags)  $(HltStore_fflags)  $(HltDataTypes_fflags)  $(HltResult_fflags)  $(SniperKernel_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags) 
use_pp_fflags=  $(HltSteering_pp_fflags)  $(HltConfig_pp_fflags)  $(HltSteerData_pp_fflags)  $(HltStore_pp_fflags)  $(HltDataTypes_pp_fflags)  $(HltResult_pp_fflags)  $(SniperKernel_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags) 
use_libraries= $(HltConfig_libraries)  $(HltSteerData_libraries)  $(HltStore_libraries)  $(HltDataTypes_libraries)  $(HltResult_libraries)  $(SniperKernel_libraries)  $(SniperPolicy_libraries)  $(Boost_libraries)  $(Python_libraries) 
fincludes= $(includes)

...
includes= $(ppcmd)"$(HltSteerData_root)"  $(ppcmd)"$(srcdir)" $(ppcmd)"/junofs/users/liuyan/OEC/EventFilter/HltProcessor/HltSteerData/include" $(ppcmd)"/junofs/users/liuyan/OEC/EventFilter/InstallArea/include" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre1/sniper/InstallArea/include" $(use_includes)
...
use_includes= $(ppcmd)"$(HltStore_root)/src" $(ppcmd)"/junofs/users/liuyan/OEC/EventFilter/HltUtilities/HltStore/include" $(ppcmd)"$(HltDataTypes_root)/src" $(ppcmd)"/junofs/users/liuyan/OEC/EventFilter/HltUtilities/HltDataTypes/include" $(ppcmd)"$(SniperKernel_root)/src" $(ppcmd)"$(SniperPolicy_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc830/Pre-Release/J20v1r0-Pre1/ExternalLibs/Boost/1.72.0/include" $(ppcmd)"$(Python_root)/src" 
